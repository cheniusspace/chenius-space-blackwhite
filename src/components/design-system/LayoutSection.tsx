    ...
    <section id="layout">
      ...
      <div className="space-y-8">
          ...
          <div className="p-4 border rounded-md">
            <div className="grid grid-cols-12 gap-2 mb-4">
              {Array.from({ length: 12 }).map((_, i) => (
                <div key={i} className="h-10 bg-white/10 flex items-center justify-center text-xs text-white">
                  {i + 1}
                </div>
              ))}
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-4">
              <div className="h-20 bg-white/10 flex items-center justify-center text-white">
        ...
        <div id="containers" className="space-y-4">
          ...
          <div className="p-4 border rounded-md">
            <div className="max-w-7xl mx-auto p-4 bg-white/10 mb-4 rounded-md">
              <div className="text-center text-white">max-w-7xl Container (1280px)</div>
            </div>
            <div className="max-w-5xl mx-auto p-4 bg-white/10 mb-4 rounded-md">
              <div className="text-center text-white">max-w-5xl Container (1024px)</div>
            </div>
            <div className="max-w-3xl mx-auto p-4 bg-white/10 rounded-md">
              <div className="text-center text-white">max-w-3xl Container (768px)</div>
            </div>
            <div className="mt-4">
              <p className="text-sm text-white/80">
          ...
          <div className="p-4 border rounded-md">
            <div className="flex flex-col space-y-4">
              <div className="flex items-center">
                <div className="w-16 h-16 bg-white/10 mr-4"></div>
                <div className="text-white">Spacing: 16px (1rem)</div>
              </div>
              <div className="flex items-center">
                <div className="w-8 h-8 bg-white/10 mr-8"></div>
                <div className="text-white">Spacing: 32px (2rem)</div>
              </div>
              <div className="flex items-center">
                <div className="w-8 h-8 bg-white/10 mr-12"></div>
                <div className="text-white">Spacing: 48px (3rem)</div>
              </div>
            </div>
            <div className="mt-4">
              <p className="text-sm text-white/80">
