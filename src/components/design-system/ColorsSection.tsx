        ...
        <div className="p-6 bg-white/5 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <div className={`h-24 ${isDark ? "bg-[#1A1B26]" : "bg-[#FEF7ED]"} rounded-lg border border-white/10`}></div>
              <div className="text-center">
                <p className="font-bold">{isDark ? "Dark Blue" : "Soft Cream"}</p>
                <p className="text-sm text-white/60">{isDark ? "#1A1B26" : "#FEF7ED"}</p>
              </div>
            </div>
            <div className="space-y-2">
        ...
        <div className="p-6 bg-white/5 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className={`p-4 ${isDark ? "bg-[#1A1B26]" : "bg-[#FEF7ED]"} rounded-lg`}>
